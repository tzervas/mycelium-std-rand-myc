# Remap Manifest — mycelium-std-rand → std.rand
...
|---|---|---|---|---|---|---|
| `std.rand` | Keep | Safe | false | true | `/root/git/isolated/mycelium/crates/mycelium-std-rand/src/lib.rs` | structure-preserving 1:1 (DN-109 §5.3-B v0 default: every emitted nodule keeps its source file's mod-tree position, no restructuring proposed) |
